 ...
 * {@link ActiveFragment.OnFragmentInteractionListener} interface
...
public class ActiveFragment extends Fragment {
    ...
    private static final String ARG_PARAM2 = "sensor";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ActiveView active = (ActiveView)view.findViewById(R.id.active);
        active.init(mParam2);
        return view;
    }
