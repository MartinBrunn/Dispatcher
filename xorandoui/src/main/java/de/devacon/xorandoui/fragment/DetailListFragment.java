...
import de.devacon.xorandoui.uiadapter.ListContentAdapter;

/**
 * A list fragment representing a list of Details. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link DetailDetailFragment}.
 * <p/>
...
public class DetailListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ListContentAdapter(activity,content,
