...
public class MyNumberPicker extends LinearLayout {
     ...
     * {@link MyNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link MyNumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link MyNumberPicker#getMinValue()} and
     * {@link MyNumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link MyNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link MyNumberPicker#getMinValue()} and
     * {@link MyNumberPicker#getMaxValue()} values.
     * <p>
    ...
    /**
     * Sets the current value of this MyNumberPicker, and sets mPrevious to the
    ...
    private void updateInputTextView() {
        ...
        if (mFlingable && accessibilityManager.isEnabled()){//AccessibilityManager.getInstance(mContext).isEnabled()) {
