...
import android.annotation.MyWidget;
 ...
 */
@MyWidget
public class YourNumberPicker extends LinearLayout {

    Context mContext;


    private static int[][] VIEW_STATE_SETS;
    private static int[] PRESSED_STATE_SET;
     ...
     */
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = R.layout.my_number_picker;
    ...
    /**
     * Use a custom MyNumberPicker formatting callback to use two-digit minutes
    ...
    private static class TwoDigitFormatter implements Formatter {
        ...
        private static char getZeroDigit(Locale locale) {
            return '0' ; // LocaleData.get(locale).zeroDigit;
        }
    ...
    /**
     * Lower value of the range of numbers allowed for the MyNumberPicker
     */
    private int mMinValue;

    /**
     * Upper value of the range of numbers allowed for the MyNumberPicker
     */
    private int mMaxValue;

    /**
     * Current value of this MyNumberPicker
     */
    private int mValue;
    ...
    public interface OnValueChangeListener {
         ...
         *
         * @param picker The MyNumberPicker associated with this listener.
         * @param oldVal The previous value.
         * @param newVal The new value.
         */
        void onValueChange(YourNumberPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(YourNumberPicker view, int scrollState);
    }
     ...
     */
    public YourNumberPicker(Context context) {
        this(context, null);
        init();
    }
     ...
     */
    public YourNumberPicker(Context context, AttributeSet attrs) {
     ...
     */
    public YourNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // input text
        mInputText = (TextView) findViewById(R.id.numberpicker_input2);
...
*/
    ...
    protected boolean dispatchHoverEvent(MotionEvent event) {
        ...
        if (true) { // AccessibilityManager.getInstance(mContext).isEnabled()) {
     ...
     * <p>
     * If the argument is less than the {@link YourNumberPicker#getMinValue()} and
     * {@link YourNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link YourNumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link YourNumberPicker#getMinValue()} and
     * {@link YourNumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link YourNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link YourNumberPicker#getMaxValue()} and
     * {@link YourNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link YourNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
    ...
    private void showSoftInput() {
        InputMethodManager inputMethodManager = null; //@ InputMethodManager.peekInstance();
     ...
     * wrap around the {@link YourNumberPicker#getMinValue()} and
     * {@link YourNumberPicker#getMaxValue()} values.
     * <p>
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mVirtualButtonPressedDrawable != null
            ...
            if (mDecrementVirtualButtonPressed) {
                ...
                mVirtualButtonPressedDrawable.setBounds(0, 0,
                        getRight(), mTopSelectionDividerTop);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(YourNumberPicker.class.getName());
    ...
    /**
     * Sets the current value of this MyNumberPicker.
     *
     * @param current The new value of the MyNumberPicker.
    ...
    /**
     * Updates the view of this MyNumberPicker. If displayValues were specified in
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            YourNumberPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            YourNumberPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        public void buttonTapped(int button) {
            ...
            mMode = MODE_TAPPED;
            mManagedButton = button;
            YourNumberPicker.this.post(this);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                YourNumberPicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (YourNumberPicker.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (YourNumberPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (YourNumberPicker.this.isEnabled()) {
                                YourNumberPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (YourNumberPicker.this.isEnabled()) {
                                ...
                                YourNumberPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (true) { //AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setSource(YourNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(YourNumberPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (true) { //AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setEnabled(YourNumberPicker.this.isEnabled());
                event.setSource(YourNumberPicker.this, virtualViewId);
                requestSendAccessibilityEvent(YourNumberPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(YourNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(YourNumberPicker.this, virtualViewId);
            info.setParent(YourNumberPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(YourNumberPicker.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(YourNumberPicker.class.getName());
            info.setPackageName(mContext.getPackageName());
            info.setSource(YourNumberPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(YourNumberPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(YourNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(YourNumberPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
